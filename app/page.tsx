      ...
      <div className="z-10 w-full max-w-xl px-5 xl:px-0">
        ...
        >
          ...
          <a
            ...
            href="https://github.com/richardfontein/radarlink"
            target="_blank"
            rel="noopener noreferrer"
          >
            <Github />
...
const features = [
  ...
  },
  {
    ...
    description:
      "Jumpstart your next project by deploying RadarLink to [Vercel](https://vercel.com/) in one click.",
    demo: (
      <a href={DEPLOY_URL}>
        <Image
  ...
  },
  {
    ...
    description:
      "RadarLink comes with authentication and database via [Auth.js](https://authjs.dev/) + [Prisma](https://prisma.io/)",
    demo: (
  ...
  },
  {
    ...
    description:
      "RadarLink offers a collection of hooks, utilities, and `@vercel/og`",
    demo: (
